  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="排放阶段" prop="emissionStage">
        <el-input
          v-model="queryParams.emissionStage"
          placeholder="请输入排放阶段"
          clearable
          @keyup.enter="handleQuery"
        />
      ...
      <el-form-item label="环保登记级编码" prop="environmentalRatingCode">
        <el-input
          v-model="queryParams.environmentalRatingCode"
          placeholder="请输入环保登记编码"
          clearable
          @keyup.enter="handleQuery"
        />
      </el-form-item>
      ...
      <el-form-item label="是否加装OBD" prop="hasObd">
        <el-input
          v-model="queryParams.hasObd"
          placeholder="请输入是否加装OBD"
          clearable
          @keyup.enter="handleQuery"
        />
      </el-form-item>
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          icon="Plus"
          @click="handleAdd"
          v-hasPermi="['system:onSiteVehicle:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['system:onSiteVehicle:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['system:onSiteVehicle:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          icon="Download"
          @click="handleExport"
          v-hasPermi="['system:onSiteVehicle:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="onSiteVehicleList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)" v-hasPermi="['system:onSiteVehicle:edit']">修改</el-button>
          <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['system:onSiteVehicle:remove']">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
